...
plt.plot(x_stream1, y_stream0, label='change in Cart Position')
plt.plot(x_stream1, y_stream1, label='change in Cart Velocity')
plt.plot(x_stream1, y_stream2, label='change in Pole Angle')
plt.plot(x_stream1, y_stream3, label='change in Pole Velocity')
plt.plot(x_stream1, y_pred_stream0, label='Predicted change in Cart Position', linestyle='dashed')
plt.plot(x_stream1, y_pred_stream1, label='Predicted change in Cart Velocity', linestyle='dashed')
plt.plot(x_stream1, y_pred_stream2, label='Predicted change in Pole Angle', linestyle='dashed')
plt.plot(x_stream1, y_pred_stream3, label='Predicted change in Pole Velocity', linestyle='dashed')
...
plt.plot(y_stream1, y_pred_stream1, label='change in Cart Velocity')
plt.plot(y_stream2, y_pred_stream2, label='change in Pole Angle')
plt.plot(y_stream3, y_pred_stream3, label='change in Pole Velocity')
plt.plot(y_stream0, y_pred_stream0, label='change in Cart Position')
